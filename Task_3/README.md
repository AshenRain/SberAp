![Image alt](https://github.com/AshenRain/SberAp/raw/main/Task_3/1.jpg)
![Image alt](https://github.com/AshenRain/SberAp/raw/main/Task_3/2.jpg)
![Image alt](https://github.com/AshenRain/SberAp/raw/main/Task_3/3.jpg)
...
def recomend_items(req, freqs, basket, absent = [], supp = 0):
    ...
    for item in basket:
        if item in req.keys():
            for re in req[item]:                                   # У каждого рекомендуемого по правилам item-а есть значение, 
                archive[re[0]] = archive.get(re[0], 0) + re[1]     # которое увеличивается, если в корзине есть другие продукты с рекомендацией
                                                                   # на данный item
